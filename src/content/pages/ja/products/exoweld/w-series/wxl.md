...
permalink: null
title: WXL
description: WXL は旧カタログに基づく Exoweld W シリーズ銅導体熱熔接接点型番です。
pageSections:
  - _component: page-sections/products/product-detail
    category: Exoweld ／ W シリーズ
    heading: WXL
    summary: WXL は旧カタログに基づく Exoweld W シリーズ銅導体熱熔接接点型番です。
    description:
      - WXL は W シリーズ銅導体接点形式で、線径と接点条件に応じた溶模・溶接剤と組み合わせます。
