...
permalink: null
title: WL
description: WL は旧カタログに基づく Exoweld W シリーズ銅導体熱熔接接点型番です。
pageSections:
  - _component: page-sections/products/product-detail
    category: Exoweld ／ W シリーズ
    heading: WL
    summary: WL は旧カタログに基づく Exoweld W シリーズ銅導体熱熔接接点型番です。
    description:
      - WL は W シリーズ銅導体接点形式で、線径と接点条件に応じた溶模・溶接剤と組み合わせます。
