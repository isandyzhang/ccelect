...
permalink: null
title: WT
description: WT copper conductor exothermic joint model for Exoweld W series installations based on legacy catalogs.
pageSections:
  - _component: page-sections/products/product-detail
    category: Exoweld / W series
    heading: WT
    summary: WT copper conductor exothermic joint model for Exoweld W series installations based on legacy catalogs.
    description:
      - WT belongs to the W series copper conductor joint family and can be paired with matching molds and welding powder by conductor size.
    ...
    imageAlt: WT Product placeholder
